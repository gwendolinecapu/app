...
// functions/src/ai/services/PromptService.ts

import { STYLES } from "../constants";

export class PromptService {
    static getRitualAnalysisPrompt(): string {
        return `
    ...
    static getRitualRefSheetPrompt(visualDescription: string): string {
        return `
      Generate a SINGLE "character turnaround sheet" image.
    ...
    static getMagicPromptExpansion(prompt: string, charDesc: string, style: string): string {
    ...
    static getChatSystemPrompt(traits: string, recentSummary: string): string {
        return `
